...
- **Scale**: 189 source modules, 945 symbols, 11 external packages, 3164 edges.
...
- `src/cli/index.ts` (28 changes/90d)
- `src/adapters/index.ts` (22 changes/90d)
- `src/mcp/index.ts` (21 changes/90d)
- `test/adapters.test.mjs` (15 changes/90d)
- `src/graph/index.ts` (14 changes/90d)
- `src/token-optimizer.ts` (13 changes/90d)
- `test/mcp.test.mjs` (12 changes/90d)
- `test/install-integration.test.mjs` (11 changes/90d)
