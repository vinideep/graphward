...
description: "Internal GraphWard engine. Use only when an entry workflow delegates implementation orchestration. Do not use for read-only audit, review, discovery, or impact analysis."
---
...
- **Use when:** an entry workflow delegates implementation orchestration.
- **Do not use when:** read-only audit, review, discovery, or impact analysis.
